...
const faqData = [
  {
    ...
    answer: "크레딧은 릴처의 모든 활동에 사용되는 화폐 단위예요.\n\n키워드 검색, URL 기반 분석 시 결과 30개를 얻는 데 100 크레딧이, 60개를 얻는 데 200 크레딧, 자막을 추출하는 데 20 크레딧이 소모돼요."
  },
  {
  ...
  },
  {
    ...
    answer: "물론이에요. 릴처는 가입하는 모든 분들께 매달 250 크레딧을 무료로 제공하는 'FREE 플랜'을 지원해요. 릴처의 핵심적인 기능들을 충분히 경험하고 서비스의 가치를 판단해 보실 수 있어요."
  },
  {
